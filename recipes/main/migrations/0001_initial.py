    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_info', models.TextField(blank=True, default='Ваше значение по умолчанию', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('Легкая', 'Легкая'), ('Средняя', 'Средняя'), ('Тяжелая', 'Тяжелая')], max_length=150)),
